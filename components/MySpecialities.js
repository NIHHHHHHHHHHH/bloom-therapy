        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8">
          {specialties.map((specialty, index) => (
            ...
            >
              ...
              {/* Description */}
              <p className="text-foreground font-medium text-sm my-4 2xl:my-10  grow">
                {specialty.description}
              </p>

              {/* Circular Image */}
              <div className="w-full aspect-square rounded-full overflow-hidden mx-auto max-w-xs  sm:max-w-57 lg:max-w-3xs 2xl:max-w-sm mt-8 2xl:mt-11 relative">
                <Image
                  src={specialty.image}
