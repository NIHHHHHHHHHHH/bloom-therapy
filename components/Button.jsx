...
// }) {
//   const baseClassName = `inline-flex items-center justify-center gap-3 px-8 py-3.5 text-foreground hover:bg-foreground hover:text-primary transition-all duration-300 text-sm font-medium uppercase group`;
