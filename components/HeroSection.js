...
//             <div className="relative w-full max-w-44 md:max-w-md lg:max-w-xl xl:max-w-2xl 2xl:max-w-3xl">
//               <div 
//                 className="relative overflow-hidden shadow-lg w-full aspect-7/10"
//                 style={{
